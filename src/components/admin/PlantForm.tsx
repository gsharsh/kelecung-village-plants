        ...
        <section className="admin-panel overflow-hidden">
          ...
          <div className="p-5 sm:p-6">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div><label htmlFor="plant-slug" className="field-label">Page URL</label><div className="flex overflow-hidden rounded-xl border border-[var(--line-strong)] bg-white"><span className="grid place-items-center border-r border-[var(--line)] bg-[var(--cream-100)] px-3 text-xs text-[var(--ink-700)]">/plants/</span><output id="plant-slug" className="min-w-0 flex-1 truncate px-3 py-3 text-sm text-[var(--ink-900)]">{slugPreview}</output></div><p className="field-help">Generated automatically from the common name. Plant names must be unique.</p></div>
            </div>
